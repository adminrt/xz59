...
<header class="green_bg">
  ...
  <div class="game_tags bg">
    ...
    <div class="top_three">
	  ...
	  <?php
$bqno=0;
$ecms_bq_sql=msys_ReturnEcmsLoopBq(1,1,1,1);
if($ecms_bq_sql){
...
?>
	  <?php
$bqno=0;
$ecms_bq_sql=msys_ReturnEcmsLoopBq(1,'1,1',1,1);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=msys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
	  <?php
$bqno=0;
$ecms_bq_sql=msys_ReturnEcmsLoopBq(1,'2,1',1,1);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=msys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
    ...
    <div class="three_behind">
	  ...
	  <?php
$bqno=0;
$ecms_bq_sql=msys_ReturnEcmsLoopBq(1,'3,7',1,1);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=msys_ReturnEcmsLoopStext($bqr);
$bqno++;
