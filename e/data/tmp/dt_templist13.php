...
<div class="crumb">
  <div class="w1200"> <i class="icon"></i>所在位置：<a href="/">首页</a>&nbsp;>&nbsp;<a href="/soft/">手机软件</a></div>
</div>
...
?>
      <div class="tab_box">
        <ul class="tab_menu">
          <li class="<?=$zuixin?>"><a href="/soft/<?=$_GET[type]?>-0-0.html">最新</a></li>
          <li class="<?=$remen?>"><a href="/soft/<?=$_GET[type]?>-1-0.html">热门</a></li>
        </ul>
...
[!--empirenews.listtemp--]
            ...
            <div class="pagecode">[!--show.kaifameisoftpage--]</div>
          </div>
        </div>
      </div>
    </div>
