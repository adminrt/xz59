...
?>    <table width=100% align=center cellpadding=3 cellspacing=1 bgcolor=#DBEAF5>
        ...
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>副标题</td>
            <td bgcolor='ffffff'><input name="ftitle" type="text" size=42 id="ftitle" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'ftitle',stripSlashes($r[ftitle]))?>">
</td>
        </tr>
        <tr>
...
<font color="#666666">(多个请用&quot;,&quot;隔开)</font></td>
        ...
        <tr>
            ...
            <td bgcolor='ffffff'><input type="file" name="titlepicfile" size="45"></td>
        </tr>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>内容简介</td>
        ...
        <tr>
            ...
            <td bgcolor='ffffff'><input name="writer" type="text" id="writer" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'writer',stripSlashes($r[writer]))?>" size="">
</td>
        </tr>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>信息来源</td>
            <td bgcolor='ffffff'><input name="befrom" type="text" id="befrom" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'befrom',stripSlashes($r[befrom]))?>" size="">
</td>
        </tr>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>游戏类型</td>
            <td bgcolor='ffffff'><select name="type" id="type"><option value="1"<?=$r[type]=="1"?' selected':''?>>角色扮演</option><option value="2"<?=$r[type]=="2"?' selected':''?>>动作格斗</option><option value="3"<?=$r[type]=="3"?' selected':''?>>休闲益智</option><option value="4"<?=$r[type]=="4"?' selected':''?>>枪战射击</option><option value="5"<?=$r[type]=="5"?' selected':''?>>战争策略</option><option value="6"<?=$r[type]=="6"?' selected':''?>>卡牌对战</option><option value="7"<?=$r[type]=="7"?' selected':''?>>音乐舞蹈</option><option value="8"<?=$r[type]=="8"?' selected':''?>>模拟经营</option><option value="9"<?=$r[type]=="9"?' selected':''?>>体育竞技</option><option value="10"<?=$r[type]=="10"?' selected':''?>>冒险解谜</option><option value="11"<?=$r[type]=="11"?' selected':''?>>其它游戏</option></select></td>
        </tr>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>游戏类型</td>
            <td bgcolor='ffffff'>
<input name="typei" type="text" id="typei" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'typei',stripSlashes($r[typei]))?>" size="">
        ...
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>大小</td>
            <td bgcolor='ffffff'>
<input name="size" type="text" id="size" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'size',stripSlashes($r[size]))?>" size="60">
</td>
        </tr>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>游戏版本</td>
            <td bgcolor='ffffff'>
<input name="bb" type="text" id="bb" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'bb',stripSlashes($r[bb]))?>" size="60">
</td>
        </tr>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>系统要求</td>
            <td bgcolor='ffffff'>
<input name="xtyq" type="text" id="xtyq" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'xtyq',stripSlashes($r[xtyq]))?>" size="60">
</td>
        </tr>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>语言</td>
            <td bgcolor='ffffff'>
<input name="yy" type="text" id="yy" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'yy',stripSlashes($r[yy]))?>" size="60">
</td>
        </tr>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>开发商</td>
            <td bgcolor='ffffff'>
<input name="kfs" type="text" id="kfs" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'kfs',stripSlashes($r[kfs]))?>" size="60">
</td>
        </tr>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>推荐评语</td>
            <td bgcolor='ffffff'>
<input name="yjh" type="text" id="yjh" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'yjh',stripSlashes($r[yjh]))?>" size="90">
</td>
        </tr>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>安卓下载地址</td>
            <td bgcolor='ffffff'><input name="downurl" type="text" id="downurl" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'downurl',stripSlashes($r[downurl]))?>" size="90">
</td>
        </tr>
         <tr>
            <td width='16%' height=25 bgcolor='ffffff'>安卓下载地址2</td>
            <td bgcolor='ffffff'><input name="downurl2" type="text" id="downurl2" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'downurl2',stripSlashes($r[downurl2]))?>" size="90">
</td>
        </tr>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>ios下载地址</td>
            <td bgcolor='ffffff'><input name="downurli" type="text" id="downurli" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'downurli',stripSlashes($r[downurli]))?>" size="90">
</td>
        </tr>
         <tr>
            <td width='16%' height=25 bgcolor='ffffff'>ios下载地址2</td>
            <td bgcolor='ffffff'><input name="downurli2" type="text" id="downurli2" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'downurli2',stripSlashes($r[downurli2]))?>" size="90">
</td>
        </tr>
        <tr>
            <td height=25 colspan=2 bgcolor='ffffff'>
                <div align=left>新闻正文</div>
            </td>
        </tr>
    </table>
    <div style='background-color:#D0D0D0'><?=ECMS_ShowEditorVar("newstext",$ecmsfirstpost==1?"":DoReqValue($mid,'newstext',stripSlashes($r[newstext])),"Default","","300","100%")?>
</div>
    <table width='100%' align=center cellpadding=3 cellspacing=1 bgcolor='#DBEAF5'>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>顶</td>
            <td bgcolor='ffffff'>
<input name="diggtop" type="text" id="diggtop" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'diggtop',stripSlashes($r[diggtop]))?>" size="">
</td>
        </tr>
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>游戏截图</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td id=addpicdown></td>
        ...
        <tr>
            <td width='16%' height=25 bgcolor='ffffff'>权限</td>
            <td bgcolor='ffffff'>
