...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>游戏版本</td><td bgcolor='ffffff'>
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>安卓下载地址</td><td bgcolor='ffffff'><input name="downurl" type="text" id="downurl" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[downurl]))?>" size="90">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>安卓下载地址2</td><td bgcolor='ffffff'><input name="downurl2" type="text" id="downurl2" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[downurl2]))?>" size="90">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>ios下载地址</td><td bgcolor='ffffff'><input name="downurli" type="text" id="downurli" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[downurli]))?>" size="90">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>ios下载地址2</td><td bgcolor='ffffff'><input name="downurli2" type="text" id="downurli2" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[downurli2]))?>" size="90">
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>游戏截图</td><td bgcolor='ffffff'><script>
function dopicadd()
{var i;
var str="";
var oldi=0;
